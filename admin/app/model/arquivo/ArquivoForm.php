...
class ArquivoForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $arquivo_novo = new TFile('arquivo_media');
        $arquivo_novo->setAllowedExtensions(['png', 'jpg', 'pdf']);
        $arquivo_novo->setCompleteAction( new TAction( [$this, 'onChangeFoto'] ) );
        ...
        $tipo = new TDBCombo( 'id_tipo', 'permission', 'ArquivoFoto', 'id', 'nome' );
        ...
        $this->form->addFields( [ new TLabel('Arquivo'), $arquivo_novo ], [new TLabel('Foto Web'), $foto_nova_web] );
        ...
        $this->form->addHeaderActionLink(_t('Back'),  new TAction(['ArquivoList', 'onReload']), 'fa:arrow-left');
